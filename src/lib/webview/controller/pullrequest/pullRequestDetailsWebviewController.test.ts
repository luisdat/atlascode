...
describe('PullRequestDetailsWebviewController', () => {
    ...
    beforeEach(() => {
        ...
        mockApi = {
            ...
            getReviewState: jest.fn().mockReturnValue({ isReviewing: false, pendingCommentCount: 0 }),
            startReview: jest.fn().mockReturnValue({ isReviewing: true, pendingCommentCount: 0 }),
            stopReview: jest.fn().mockResolvedValue({ isReviewing: false, pendingCommentCount: 0 }),
            checkout: jest.fn(),
            ...
            getViewedFiles: jest.fn().mockReturnValue([]),
            setFileViewed: jest.fn().mockResolvedValue([]),
        };
        mockCommonHandler = {
